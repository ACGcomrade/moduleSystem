...
template <> constexpr inline auto ModuleManager::qt_create_metaobjectdata<qt_meta_tag_ZN13ModuleManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'moduleTypeCountChanged'
        QtMocHelpers::SignalData<void(ModuleBase::ModuleType, int)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void ModuleManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->moduleTypeCountChanged((*reinterpret_cast< std::add_pointer_t<ModuleBase::ModuleType>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (ModuleManager::*)(ModuleBase * )>(_a, &ModuleManager::moduleDestroyed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ModuleManager::*)(ModuleBase::ModuleType , int )>(_a, &ModuleManager::moduleTypeCountChanged, 2))
            return;
    }
}
...
// SIGNAL 2
void ModuleManager::moduleTypeCountChanged(ModuleBase::ModuleType _t1, int _t2)
{
