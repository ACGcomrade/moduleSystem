...
void PerformanceMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->performanceWarning((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->performanceCritical((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PerformanceMonitor::*)(const QString & )>(_a, &PerformanceMonitor::performanceWarning, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (PerformanceMonitor::*)(const QString & )>(_a, &PerformanceMonitor::performanceCritical, 1))
            return;
    }
}
...
// SIGNAL 0
void PerformanceMonitor::performanceWarning(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void PerformanceMonitor::performanceCritical(const QString & _t1)
{
